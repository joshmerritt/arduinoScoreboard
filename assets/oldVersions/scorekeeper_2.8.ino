...
void updateTimeDisplay() {
    ...
    switch(elapsedGameTime) {
      ...
      case 16:
        {
        fill_gradient(leds,18,CHSV(HUE_GREEN,255,255),21,CHSV(10, 255, 255));
        }
        break;
      case 17:
        {
        fill_gradient(leds,18,CHSV(HUE_GREEN,255,255),22,CHSV(10, 255, 255));
        }
        break;
      case 18:
        {
        fill_gradient(leds,18,CHSV(HUE_GREEN,255,255),23,CHSV(10, 255, 255));
        }
        break;
      case 19:
        {
